...
export default function QuickCheckout({ product, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Dados simplificados com endereço padrão
      const response = await createPayment({
        ...
        orderId,
        items,
        // Endereço padrão para simplificar
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 border-b border-gray-800">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-white">Checkout Rápido</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <h3 className="text-lg font-semibold text-white mb-4">Dados Essenciais</h3>
